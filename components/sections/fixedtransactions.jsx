...
export const PersonalInfo = ({ personalData }) => {
   ...
   const details = [
      { title: 'Savings goal', value: personalData?.fixed_savings?.name },
      { title: 'Preferred Frequency', value: personalData.fixed_savings?.deposit_account_type },
      { title: 'Deposit amount', value: personalData.fixed_savings?.transaction_history[0]?.amount
   }, 
      { title: 'Fund source', value: personalData.fixed_savings?.transaction_history[0]?.transaction_type},
      { title: 'Interest', value: personalData.fixed_savings?.interest },
      { title: 'Target amount', value: personalData.fixed_savings?.withdrawal_account_details?.bank_name },
      { title: 'Expected return', value: personalData.fixed_savings?.expected_return   },
      { title: 'Start date', value: personalData.fixed_savings?.start_date },
      { title: 'End date', value: personalData.fixed_savings?.stop_date },
      { title: 'Withdrawal type', value:personalData.fixed_savings?.withdrawal_account_details?.bank_name },
      { title: 'Withdrawal method', value: personalData.fixed_savings?.withdrawal_account_details?.bank_name },
   ];
...
export const PersonalSaving = ({personalData }) => {
    ...
    */
   let rows = [];
   if (personalData.fixed_savings) {
      const transactionHistory = personalData.fixed_savings.transaction_history;
