...
import {
    Avatars, DataTable, Layout, SubPageHeader, SVG
} from '../../../components';
   ...
   const data = React.useMemo(
      () => [
         ...
         },
         {
            group: [
               'Devon Lane',
               ['person4', 'person3', 'person1', 'person4'],
            ],
            service: 'Fund Deposit',
            amount: '5000',
            paymentMethod: 'Debit Card',
      ...
      <Layout
         pageLabel={
            <span className=' space-x-2 lg:space-x-3 '>
               ...
               <span>Products</span>
               <SVG.DoubleRight />{' '}
               <span className='text-[#999999]'>Group Savings</span>
            </span>
         }
         title='Group Savings'
      >
         <SubPageHeader label='Group Savings' />
